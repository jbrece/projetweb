...
<body>
	...
	<div id="navigation1">
		<table>
			<tr>
				...
				<td align="center"><a class="onglet" href="panierclient.php"><img src="images/fond/panierimg.jpg" alt="panierclient" width="40" height="40"/><strong>Panier</a></strong></td>
	...
	<form action="1traitement.php" method="post">
		...
		<div id ="navigation2">
			<p><br><br><input type="checkbox" name="parametre" value="Activer_la_fontion_d_alerte">Activer la fontion d'alerte (Si la fonction d'alerte est activée, vous serez averti lorsqu'un article de votre choix devient disponible)</p><br>
